"use strict";
! function(e) { e.fn.circliful = function(t, r) { var n = e.extend({ foregroundColor: "#75A99D", backgroundColor: "#ccc", pointColor: "none", fillColor: "none", foregroundBorderWidth: 15, backgroundBorderWidth: 15, pointSize: 28.5, fontColor: "#aaa", percent: 75, animation: 1, animationStep: 5, icon: "none", iconSize: "30", iconColor: "#ccc", iconPosition: "top", target: 0, start: 0, showPercent: 1, percentageTextSize: 22, percentageX: 100, percentageY: 113, textAdditionalCss: "", targetPercent: 0, targetTextSize: 17, targetColor: "#2980B9", text: null, textStyle: null, textColor: "#666", textY: null, textX: null, multiPercentage: 0, percentages: [], multiPercentageLegend: 0, textBelow: !1, noPercentageSign: !1, replacePercentageByText: null, halfCircle: !1, animateInView: !1, decimals: 0, alwaysDecimals: !1, title: "Circle Chart", description: "", progressColor: null }, t); return this.each(function() {
            function t() { var e = P,
                    t = W; if (1 === n.multiPercentage) { var r, l, a = n.percentages,
                        c = 360; for (r = 0; r < a.length; ++r) l = a[r].percent, t = c / 100 * l, e = d.find("#circle" + (r + 1)), r > 0 && (c += 62.5, t = c / 100 * l), o(e, t, c, l) } else o(e, t, 360, l) }

            function o(t, o, l, a) { var c = window.setInterval(function() { B >= o ? (window.clearInterval(c), S = 1, "function" == typeof r && r.call(this)) : (B += T, z += X), n.halfCircle ? 2 * B / (l / 100) >= a && 1 === S && (B = l / 100 * a / 2) : B / (l / 100) >= a && 1 === S && (B = l / 100 * a), z > n.target && 1 === S && (z = n.target), null === n.replacePercentageByText && (Y = n.halfCircle ? parseFloat(100 * B / l * 2) : parseFloat(100 * B / l), Y = Y.toFixed(n.decimals), !n.alwaysDecimals && (0 === a || a > 1 && 1 !== S) && (Y = parseInt(Y))), t.attr("stroke-dasharray", B + ", 20000"), 1 !== n.multiPercentage ? 1 === n.showPercent ? b.find(".number").text(Y) : (b.find(".number").text(z), b.find(".percent").text("")) : (b.find(".number").text(""), b.find(".percent").text("")), null !== w && e.each(w, function(e, r) { n.halfCircle && (e /= 2), B >= e * (l / 100) && t.css({ stroke: r, transition: "stroke 0.1s linear" }) }) }.bind(t), v) }

            function l() { var t = -1 !== navigator.userAgent.toLowerCase().indexOf("webkit") ? "body" : "html",
                    r = e(t).scrollTop(),
                    n = r + e(window).height(),
                    o = Math.round(P.offset().top),
                    l = o + P.height(); return n > o && l > r }

            function a() { P.hasClass("start") || l(P) && (P.addClass("start"), setTimeout(t, 250)) }

            function c(t, r) { e.each(t, function(e, n) { e.toLowerCase() in r && (t[e] = r[e.toLowerCase()]) }) }

            function i() { if (1 === n.multiPercentage) { var t, r, o, l, a, c = n.percentages,
                        i = 47,
                        p = 360,
                        u = -90; for (t = 0; t < c.length; ++t) o = c[t].percent, l = c[t].color, r = p / 100 * o, t > 0 && (p += 62.5, r = p / 100 * o), i += 10, a += '<circle cx="100" cy="100" r="' + i + '" class="border" fill="' + n.fillColor + '" stroke="' + n.backgroundColor + '" stroke-width="' + m + '" stroke-dasharray="' + p + '" transform="rotate(' + u + ',100,100)" /><circle class="circle" id="circle' + (t + 1) + '" data-percent="' + o + '" cx="100" cy="100" r="' + i + '" class="border" fill="none" stroke="' + l + '" stroke-width="' + n.foregroundBorderWidth + '" stroke-dasharray="' + r + ',20000" transform="rotate(' + u + ',100,100)" />';
